...
function getAreaData() {
    ...
    return [[props.data.tStar, props.data.qStar, props.data.qStar]].concat(areaData)
}
...
const chartOptions = {
    ...
    series: [
        ...
        {
            name: 'Intersection',
            data: [[props.data.tStar, (props.data.qStar)]],
            color: 'red',
            type: 'scatter',
            maxPointWidth: 1,
            marker: {
...
function updateGraph() {
    if (props.data.tStar <= 0) {
        ...
        chartOptions.yAxis.max = Math.max(props.data.qStar * 2, 2)
    }
