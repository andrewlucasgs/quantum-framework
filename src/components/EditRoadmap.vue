    ...
    <Dialog title="Roadmap" button-label="Advanced options" ref="dialog" @save="save" @cancel="cancel" @reset="reset"
        ...
        <template #content>
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="overflow-y-scroll flex-[0.5] flex-col gap-4">
                    <div class="w-full mb-4">
                <p class="text-xs text-justify text-gray-600 ">Adjust the values within the roadmap or incorporate additional data points as needed. Interpolation will be used to address any gaps between existing milestones on the roadmap. For projecting future trends and values beyond the current roadmap, regression analysis will be utilized.</p>
                    ...
                    <table class=" text-sm  w-full border-collapse border-spacing-2 border border-slate-500">
                        <thead class="border rounded-xl">
                            <tr class="text-gray-700">
                                ...
                                <th class="border border-slate-200 p-1"># of Physic Qubits</th>
                        ...
                        <tbody class="">
                            <tr v-for="(roadmap, index) in roadmapData" :key="index">
                                ...
                                <td class="border border-slate-200 p-1">
                                    <button class="text-sm text-red-900 hover:text-red-500 transition-all" @click="roadmapData.splice(index, 1)">
